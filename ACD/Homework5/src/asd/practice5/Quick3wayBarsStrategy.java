...
private boolean isSorted(Comparable<T>[] a) {
    ...
    private void sort(Comparable<T>[] array,Comparator<T> comparator, int l, int r) {
        if (l >= r)
            return;
        Comparable<T> middle = array[l];
        int i = l + 1;
        ...
        sort(array,comparator,  l, lEdge - 1);
        sort(array,comparator,  rEdge + 1, r);

    }

    private void sortDesc(Comparable<T>[] array, int l, int r) {
        if (l >= r)
            return;
        Comparable<T> middle = array[l];
        int i = l + 1;
        ...
        sortDesc(array,  l, lEdge - 1);
        sortDesc(array,  rEdge + 1, r);

    }

    private void sortDesc(Comparable<T>[] array,Comparator<T>  comparator,int l, int r) {
        if (l >= r)
            return;
        Comparable<T> middle = array[l];
        int i = l + 1;
        ...
        sortDesc(array,comparator,  l, lEdge - 1);
        sortDesc(array, comparator, rEdge + 1, r);
